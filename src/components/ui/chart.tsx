...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      if (hideLabel || !tooltipPayload || !Array.isArray(tooltipPayload) || tooltipPayload.length === 0) {
        return null;
      }
    ...
    if (!active || !tooltipPayload || !Array.isArray(tooltipPayload) || tooltipPayload.length === 0) {
      return null;
    }
